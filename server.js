...
session.on('packet', function(raw_packet) {
	...
	for (client in clients)
		clients[client].send(JSON.stringify({"type": "packet", "packet": {"sloc": geolocation.getGeoDataSync(saddr), "dloc": geolocation.getGeoDataSync(daddr), "saddr": saddr, "daddr": daddr, "size": size}}));
});
